...
var eightball = [ // sets the answers to an eightball
    ...
    "no u.",
    "Thonk",
    "Stupid... Like Phwee and dino",
    "Sure! I'm going to help you!",
    "Where do you live?",
    "Ajit Pai is ugly",
    "Agreed!",
    "What a liar!",
    ...
    "ok",
    "good to you",
    "your profile pic is sexy",
    "turtles are strange like Dinosaurs.",
    "fuck me daddy",
    "eat me daddy",
    "burn me daddy",
]
...
bot.on("ready", function() { // when the bot starts up, set its game to Use *help and tell the console "Booted up!"
    bot.user.setGame("Thinking with Thinkios! | *help")
...
bot.on("message", function(message) { // when a message is sent
    ...
    if (command == "info") { // creates the command *info
        message.channel.send("You can do *help to see all of my commands!") // gives u info
    }
...
bot.login('NDA1MzYyNDEzNjcyNTk1NDU3.DUpagQ.vTARP6WgygsZGrWnrTUwb8zIUFI');
